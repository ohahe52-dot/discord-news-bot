...
class Config:
    ...
    SEARXNG_MIN_DELAY     = float(os.getenv("SEARXNG_MIN_DELAY", "0.10") or 0.10)
    SEARXNG_MAX_DELAY     = float(os.getenv("SEARXNG_MAX_DELAY", "0.20") or 0.20)
    REQUEST_PACE_MIN_DELAY = float(os.getenv("REQUEST_PACE_MIN_DELAY", "0.10") or 0.10)
    REQUEST_PACE_MAX_DELAY = float(os.getenv("REQUEST_PACE_MAX_DELAY", "0.20") or 0.20)
